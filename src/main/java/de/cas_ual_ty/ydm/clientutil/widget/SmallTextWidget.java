...
public class SmallTextWidget extends Widget
{
    ...
    public SmallTextWidget(int xIn, int yIn, int widthIn, int heightIn, Supplier<ITextComponent> msgGetter, ITooltip tooltip)
    {
    ...
    public SmallTextWidget(int xIn, int yIn, int widthIn, int heightIn, Supplier<ITextComponent> msgGetter)
    {
    ...
    public void renderWidget(MatrixStack ms, int mouseX, int mouseY, float partialTicks)
    {
        ...
        AbstractGui.drawCenteredString(ms, fontrenderer, this.getMessage(), x * 2, y * 2 - fontrenderer.FONT_HEIGHT / 2, j | MathHelper.ceil(this.alpha * 255.0F) << 24);
