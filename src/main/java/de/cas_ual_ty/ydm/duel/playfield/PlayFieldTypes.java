...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType(8000)
        ...
        .newInteraction().icon(ActionIcons.ATK_TO_SET).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.SET, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardInPosition(CardPosition.ATK).cardIsOnTop().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.SET_TO_DEF).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.DEF, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardInPosition(CardPosition.SET).cardIsOnTop().addInteraction()
        .newInteraction().icon(ActionIcons.DEF_TO_SET).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.SET, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardInPosition(CardPosition.DEF).cardIsOnTop().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.OVERLAY).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> PlayFieldTypes.straightenCardsBelowAndDoAction(ActionTypes.LIST, player, interactee, new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, card.getCardPosition(), player))).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interactorUnequalsInteractee().interacteeNonEmpty().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.SPECIAL_SUMMON_OVERLAY_ATK).interactorExcluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> PlayFieldTypes.straightenCardsBelowAndDoAction(ActionTypes.SPECIAL_SUMMON_OVERLAY, player, interactee, new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player))).playerAndInteractorSameOwner().interacteeNonEmpty().addInteraction()
        .newInteraction().icon(ActionIcons.SPECIAL_SUMMON_OVERLAY_DEF).interactorExcluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> PlayFieldTypes.straightenCardsBelowAndDoAction(ActionTypes.SPECIAL_SUMMON_OVERLAY, player, interactee, new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.DEF, player))).playerAndInteractorSameOwner().interacteeNonEmpty().addInteraction()
