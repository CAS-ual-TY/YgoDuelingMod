...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType(8000)
        ...
        .newInteraction().icon(ActionIcons.ATK_TO_SET).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new ChangePositionAction(ActionTypes.CHANGE_POSITION, interactor, card, CardPosition.SET)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardInPosition(CardPosition.ATK).cardIsOnTop().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.DEF_TO_SET).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new ChangePositionAction(ActionTypes.CHANGE_POSITION, interactor, card, CardPosition.SET)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardInPosition(CardPosition.DEF).cardIsOnTop().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.SPECIAL_SUMMON_OVERLAY_ATK).interactorExcluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> PlayFieldTypes.straightenCardsBelowAndDoAction(ActionTypes.SPECIAL_SUMMON_OVERLAY, player, interactee, new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player))).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeNonEmpty().addInteraction()
        .newInteraction().icon(ActionIcons.SPECIAL_SUMMON_OVERLAY_DEF).interactorExcluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> PlayFieldTypes.straightenCardsBelowAndDoAction(ActionTypes.SPECIAL_SUMMON_OVERLAY, player, interactee, new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.DEF, player))).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeNonEmpty().addInteraction()
        ...
        .newAdvancedInteraction().icon(ActionIcons.ALL_TO_GRAVEYARD).interactorIncluded(ImmutableList.of(ZoneTypes.MONSTER, ZoneTypes.EXTRA_MONSTER_LEFT, ZoneTypes.EXTRA_MONSTER_RIGHT, ZoneTypes.EXTRA, ZoneTypes.HAND)).interactorCardAny().interacteeEquals(ZoneTypes.GRAVEYARD).interaction((player, interactor, card, interactee) -> PlayFieldTypes.doForAllCardsInZone(ActionTypes.LIST, interactor, (c) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, c, interactee, CardPosition.ATK, player))).playerAndInteractorSameOwner().interactorNonEmpty().addInteraction();
