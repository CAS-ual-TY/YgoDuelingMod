...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType()
        ...
        .newInteraction().icon(ActionIcons.VIEW_DECK).interactorEquals(ZoneTypes.DECK).interactorCardAny().interacteeEquals(ZoneTypes.DECK).interaction((player, interactor, card, interactee) -> new ViewZoneAction(ActionTypes.VIEW_ZONE, interactor)).playerAndInteractorSameOwner().interactorEqualsInteractee().addInteraction()
