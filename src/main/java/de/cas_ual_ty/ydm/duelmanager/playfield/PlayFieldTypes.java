...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType()
        ...
        .registerInteration(YdmActionIcons.ADD_TO_HAND, ZoneTypes.DECK, ZoneTypes.HAND, (deck, hand) -> hand.getCardsAmount() == 0 ? null : new MoveTopAction(ActionType.MOVE_ON_TOP, deck, (short)0, hand, CardPosition.FACE_DOWN));
}
