...
public class PlayFieldTypes
{
    public static final PlayFieldType DEFAULT = new PlayFieldType()
        ...
        .newInteraction().icon(ActionIcons.BANISH_FD).interactorUnequals(ZoneTypes.BANISHED).interactorCardNotNull().interacteeEquals(ZoneTypes.BANISHED).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.FACE_DOWN, player)).playerAndInteractorSameOwner().cardAndInteracteeSameOwner().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.SET_SPELL_TRAP_FD).interactorExcluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.FACE_DOWN, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interacteeEmpty().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.SET_SPELL_TRAP_FD).interactorIncluded(PlayFieldTypes.getAllSpellZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllSpellZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.FACE_DOWN, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.FACE_DOWN).addInteraction()
        ...
        .newInteraction().icon(ActionIcons.TO_TOP_OF_DECK_FD).interactorUnequals(ZoneTypes.EXTRA_DECK).interactorCardNotNull().interacteeEquals(ZoneTypes.EXTRA_DECK).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.FACE_DOWN, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().addInteraction()
        .newInteraction().icon(ActionIcons.TO_TOP_OF_DECK_FA).interactorUnequals(ZoneTypes.EXTRA_DECK).interactorCardNotNull().interacteeEquals(ZoneTypes.EXTRA_DECK).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().addInteraction()
        ...
        .newInteraction().icon(ActionIcons.MOVE).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(ImmutableList.of(ZoneTypes.EXTRA_MONSTER_RIGHT, ZoneTypes.EXTRA_MONSTER_LEFT)).cardNotInPosition(CardPosition.SET).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, card.getCardPosition(), player)).playerAndInteractorSameOwner().interactorUnequalsInteractee().interacteeEmpty().addInteraction()
        .newInteraction().icon(ActionIcons.ATK_DEF_TO_SET).interactorEquals(ZoneTypes.MONSTER).interactorCardNotNull().interacteeEquals(ZoneTypes.MONSTER).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.SET, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.SET).addInteraction()
        .newInteraction().icon(ActionIcons.DEF_TO_ATK).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.ATK, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.ATK).addInteraction()
        .newInteraction().icon(ActionIcons.ATK_TO_DEF).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, CardPosition.DEF, player)).playerAndInteractorSameOwner().interactorEqualsInteractee().cardNotInPosition(CardPosition.DEF).addInteraction()
        //        .newInteraction().icon(ActionIcons.OVERLAY).interactorIncluded(PlayFieldTypes.getAllMonsterZones()).interactorCardNotNull().interacteeIncluded(PlayFieldTypes.getAllMonsterZones()).interaction((player, interactor, card, interactee) -> new MoveTopAction(ActionTypes.MOVE_ON_TOP, interactor, card, interactee, card.getCardPosition())).playerAndInteractorSameOwner().interactorAndInteracteeSameOwner().interactorUnequalsInteractee().interacteeNonEmpty().addInteraction() //TODO all cards below must be put into ATK
